...
class Normalizer
{
    ...
    {
        if (!\in_array($form, [self::NFD, self::NFKD, self::NFC, self::NFKC, self::NFKC_CF])) {
            return false;
        }
    ...
    public static function normalize(string $s, int $form = self::FORM_C)
    {
        ...
        switch ($form) {
            ...
            case self::NFKC_CF: $C = true; $K = false; $CF = true; break;
            default:
        ...
        if ($CF) {
            if (null === self::$kcCF) {
                self::$kcCF = self::getData('nfkcCaseFolding');
            }
