...
class Php73Test extends TestCase
{
    ...
    public function arrayKeyFirstDataProvider()
    {
        return [
            ...
            ['f',   ['f' => 'fff', '1' => 'one', 4 => 6, '' => 'blank', 2.4 => 'float', 'F' => 'FFF', 'blank' => '', 3.7 => 3.7, 5.4 => 7, 6 => 8.6, '5' => 'Five', '4name' => 'jonny', 'a' => null, null => 3]],
            [0,     [12, 'name', 'age', '45']],
            [0,     [['oNe', 'tWo', 4], [10, 20, 30, 40, 50], []]],
            ['one', ['one' => 1, 'one' => 2, 'three' => 3, 3, 4, 3 => 33, 4 => 44, 5, 6, 5.4 => 54, 5.7 => 57, '5.4' => 554, '5.7' => 557]],
            [0,     ['foo']],
            [1,     [1 => '42']],
        ];
    }
    ...
    public function arrayKeyLastDataProvider()
    {
        return [
            ...
            ['a',   ['f' => 'fff', '1' => 'one', 4 => 6, '' => 'blank', 2.4 => 'float', 'F' => 'FFF', 'blank' => '', 3.7 => 3.7, 5.4 => 7, 6 => 8.6, '5' => 'Five', '4name' => 'jonny', 'a' => null, null => 3]],
            [3,     [12, 'name', 'age', '45']],
            [2,     [['oNe', 'tWo', 4], [10, 20, 30, 40, 50], []]],
            ['5.7', ['one' => 1, 'one' => 2, 'three' => 3, 3, 4, 3 => 33, 4 => 44, 5, 6, 5.4 => 54, 5.7 => 57, '5.4' => 554, '5.7' => 557]],
            [0,     ['foo']],
            [1,     [1 => '42']],
        ];
    }
