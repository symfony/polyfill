...
class Php73Test extends TestCase
{
    ...
    public static function arrayKeyFirstDataProvider()
    {
        return [
            ...
            ['f',   ['f' => 'fff', '1' => 'one', 4 => 6, '' => 'blank', 24 => 'float', 'F' => 'FFF', 'blank' => '', 3 => 3.7, 5 => 7, 6 => 8.6, '5' => 'Five', '4name' => 'jonny', 'a' => null]],
            [0,     [12, 'name', 'age', '45']],
    ...
    public static function arrayKeyLastDataProvider()
    {
        return [
            ...
            ['a',   ['f' => 'fff', '1' => 'one', 4 => 6, '' => 'blank', 2 => 'float', 'F' => 'FFF', 'blank' => '', 3 => 3.7, 5 => 7, 6 => 8.6, '5' => 'Five', '4name' => 'jonny', 'a' => null]],
            [3,     [12, 'name', 'age', '45']],
